...
namespace GarageKit
{
    public class VRTKUtil_3DCanvasCameraHelper : MonoBehaviour
    {
#if USE_VRTK
        private Canvas ui3DCanvas;
        private VRTKUtil_OnPreRenderActions onPreRenderActions;
        ...
        void Update()
        {
            ...
            {
                onPreRenderActions = Camera.main.GetComponent<VRTKUtil_OnPreRenderActions>();
